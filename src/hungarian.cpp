// this code from https://github.com/mcximing/hungarian-algorithm-cpp
...
//********************************************************//
double HungarianAlgorithm::Solve(std::vector <std::vector<float> >& DistMatrix, std::vector<int>& Assignment)
{
